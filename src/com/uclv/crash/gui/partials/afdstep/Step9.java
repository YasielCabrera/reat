 ...
 */
public class Step9 extends javax.swing.JPanel {
    private final Step step;

    /**
     * Creates new form Step9
     * @param step
     */
    public Step9(Step step) {
        initComponents();
        this.step = step;
        
        boolean con = (boolean) step.getData()[0];
        List<State> U = (List<State>) step.getData()[1];
        List<List<State>> eC = (List<List<State>>) step.getData()[2];
        List<State> nS = (List<State>) step.getData()[3];
        List<Boolean> mark = (List<Boolean>) step.getData()[4];
            
        jTextArea2.setText("Se verifica si U esta en S'. En esta iteración U "+(con? "está ":"no está ")+"en S'.");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("si U no está en S'");
        ...
        jTextArea2.setText("Se verifica si U esta en S'");
