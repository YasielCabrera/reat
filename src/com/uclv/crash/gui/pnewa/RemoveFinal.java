 ...
 */
public class RemoveFinal extends javax.swing.JPanel {

    private final NewAutomata REFERENCE;

    /**
     * Creates new form RemoveFinal
     *
     * @param reference
     */
    public RemoveFinal(NewAutomata reference) {
        REFERENCE = reference;
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ELIMINAR ESTADO FINAL");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(errorLb, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 260, Short.MAX_VALUE)
    ...
    private void acceptBttnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_acceptBttnMouseClicked
        Integer id = Integer.parseInt(nameTf.getText());
        if (REFERENCE.removeFinal(id)) {
            REFERENCE.changeCover(new Init(REFERENCE));
        }else{
            errorLb.setText("El estado indicado no existe.");
